#!/usr/bin/env bash
# Modified from https://raw.githubusercontent.com/dusty-nv/jetson-inference/master/docker/run.sh
#
...
--volume $PWD/rsinfer:$DOCKER_ROOT/$DETECTION_DIR/rsinfer \
...
sudo docker run --runtime nvidia -it --rm \
    ...
    -w /jetson-inference/python/training/detection/ssd \
    $V4L2_DEVICES $DATA_VOLUME $USER_VOLUME \
    rsinference:latest $USER_COMMAND
